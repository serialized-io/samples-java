...
See the details [here](https://github.com/serialized-io/samples-java/tree/master/dropwizard-order-service/src/main/java/io/serialized/samples/orderservice/api/command) 
